namespace SafeChat.Mobile.Models.DTOs.Messages;

/// <summary>
/// DTO de mensagem encriptada devolvido pela API ou recebido via SignalR.
/// O servidor nunca contém o texto claro — apenas payloads encriptados.
/// </summary>
